...
function ApiPaymentRequest(cardOwnerName, cardNumber, cardExpireMonth, cardExpireYear, cardCvc, installment) {
    return new Promise((resolve, reject) => {
        ...
        const xml_data = '<?xml version="1.0" encoding="UTF-8"?>\n' +
            ...
            "    <cardOwnerName>" + encodeURIComponent(cardOwnerName) + "</cardOwnerName>\n" +
        ...
        axios({
            ...
            headers: {
                ...
                "token": (helpers.CreateToken(settings.publicKey, settings.privateKey + orderId + amount + settings.mode + cardOwnerName + cardNumber + cardExpireMonth + cardExpireYear + cardCvc + "" + "" + "Muhammed Furkan" + "Aydın" + "enterdarkside@gmail.com" + transactionDateForRequest)),
...
module.exports = ApiPaymentRequest;